...
// const Slider2 = slider_fun();
const new_skills = new Slider2("myproducts_prev","myproducts_next", "myproducts_display", "myproducts_slider",  "myproducts_card",  5000);
new_skills.slider_start();

// myproducts
const mybusinesstraining = new Slider2("mybusinesstraining_prev","myproducts_next", "mybusinesstraining_display", "mybusinesstraining_slider",  "mybusinesstraining_card",  5000);
mybusinesstraining.slider_start();
...
document.addEventListener( 'DOMContentLoaded', function() {
    var splide = new Splide( '.splide__testimonials', {
