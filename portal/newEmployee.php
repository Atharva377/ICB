...
<body style="background: #fff;">
    ...
    <div class="tableContainer attend">
        <form action="./database/upgradeToEmployee.php" id="empDetails" method="post"  class=" col-md-4">
            ...
            <input type="text" name="uan" placeholder="UAN" id="uan">
            <input type="text" name="pfno" placeholder="PF NO." id="pfno">
            <input type="text" name="pt" placeholder="PT" id="pt">
            <input type="text" name="pf" placeholder="PF" id="pf">
            <input type="text" name="insurance" placeholder="Insurance" id="insurance">
            <input type="text" name="tds" placeholder="TDS" id="tds">
            <input type="text" name="other" placeholder="Other" id="other"> 
            ...
            <div class="pass-group" id="pass-group">
                <input type="password" name="password" placeholder="Create Password" id="userPassword">
    ...
    $('#existEmployee').change(function () {
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                $('#pt').val(res[0].pt);
                $('#pf').val(res[0].pf);
                $('#insurance').val(res[0].insurance);
                $('#tds').val(res[0].tds);
                $('#other').val(res[0].other);
