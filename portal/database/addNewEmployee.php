<?php
    ...
    $userExpirationDate = date("Y-m-d", strtotime($newUserRegistrationDate."+365 days"));
    ...
    if ($mysqli->query($sql_a)){
        echo "<script>if(confirm('New Employee Added Successfully!')){window.location.href='http://localhost/ICB/portal/newEmployee.php';}else{window.location.href='http://localhost/ICB/portal/newEmployee.php';}</script>";
