<?php   
    ...
    if($today <= $eDate){
        ...
        $sql = "INSERT INTO events (eventName, eventInitiative, eventTableName, eventDate, eventVenue, eventTime, endTime, eventRequirements) VALUES ('$eventName', '$eventInitiative', '$eventTableName', '$eDate', '$eventVenue', '$eStartTime', '$eEndTime', '$eventRequirements')";
