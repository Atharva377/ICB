...
<<<<<<< HEAD
                    case "admin": $borderColor2= '#0ED678'; 
                                  $checkSrc2= './images/checkadmin.png';
                                  break;
                    case "core-team": $borderColor2= '#FC8955';
                                    $checkSrc2= './images/shield core-team.png';
                                      break;
                    case "member": $borderColor2= '#2196F3';
                                   $checkSrc2= './images/memberProfile.svg';
                                   break;
                    case "student": $borderColor2= '#FFC4C4';
                                    break;
=======
                    case "member": $borderColor2= '#2196F3';
                                   $checkSrc2= './images/memberProfile.svg';
